 ...
 */
ESConnector.prototype.makeFilterIndexAndType = function () {
    var filter = {};
    if (this.searchIndex) {
 ...
 */
ESConnector.prototype.makeFilter = function (criteria, size, page) {
    var filter = this.makeFilterIndexAndType();
    if (size && (size != null)) {
        if (size < 1) {
            if (this.defaultSize) {
...
ESConnector.prototype.exists = function (model, id, done) {
    var self = this;
    var filter = self.makeFilterIndexAndType();
...
ESConnector.prototype.create = function (model, data, done) {
    var self = this;
    var document = self.makeFilterIndexAndType();
